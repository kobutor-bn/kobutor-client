    ...
    return (
        <>
            <button id="dropdownHelperButton" data-dropdown-toggle="dropdownHelper"
                    ...
                    type="button">Dropdown checkbox <svg className="w-2.5 h-2.5 ms-3" aria-hidden="true"
            ...
            <div id="dropdownHelper"
                ...
                <ul className="p-3 space-y-1 text-sm text-gray-700 dark:text-gray-200"
                            ...
                            <div className="ms-2 text-sm">
                                <label htmlFor="helper-checkbox-1"
                                    ...
                                    <p id="helper-checkbox-text-1"
                                       className="text-xs font-normal text-gray-500 dark:text-gray-300">Some helpful
                    ...
                    <li>
                        <div className="flex p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                            <div className="flex items-center h-5">
                                <input id="helper-checkbox-3" aria-describedby="helper-checkbox-text-3" type="checkbox"
                                       value=""
                                       className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"/>
                            </div>
                            <div className="ms-2 text-sm">
